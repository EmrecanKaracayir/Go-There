package com.sep.gothere.features.root_postlog.explore.leaf_business_profile_explore.ui
...
import com.sep.gothere.features.root_postlog.explore.leaf_business_profile_explore.vm.BusinessProfileExploreViewModel
...
@AndroidEntryPoint
class BusinessProfileFragmentExplore : BaseFragment(R.layout.fragment_business_profile_common),
    NavigationInfoProvider {

    @Inject
    lateinit var networkVenueRepository: NetworkVenueRepository

    private val viewModel: BusinessProfileExploreViewModel by viewModels()
            ...
            lifecycleScope.launch {
                viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                    viewModel.events.collect { event ->
                        when (event) {
                            is BusinessProfileExploreViewModel.Event.VenueError -> {}
                            is BusinessProfileExploreViewModel.Event.VenueLoading -> {}
                            is BusinessProfileExploreViewModel.Event.VenueSuccessful -> {
