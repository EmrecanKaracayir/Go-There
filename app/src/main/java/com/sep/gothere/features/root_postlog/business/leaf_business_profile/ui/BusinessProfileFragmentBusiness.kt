package com.sep.gothere.features.root_postlog.business.leaf_business_profile.ui
...
import com.sep.gothere.databinding.FragmentBusinessProfileBusinessBinding
import com.sep.gothere.features.root_postlog.business.leaf_business_profile.vm.BusinessProfileViewModel
...
@AndroidEntryPoint
class BusinessProfileFragmentBusiness : BaseFragment(R.layout.fragment_business_profile_business),
    ...
    private var _binding: FragmentBusinessProfileBusinessBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBusinessProfileBusinessBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            editButton.setOnClickListener {
                val bundle = Bundle()
                bundle.putLong(BUNDLE_ID_KEY, venueID)
            ...
            lifecycleScope.launch {
                viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                    viewModel.events.collect { event ->
                        when (event) {
                            is BusinessProfileViewModel.Event.VenueError -> {}
                            is BusinessProfileViewModel.Event.VenueLoading -> {}
                            is BusinessProfileViewModel.Event.VenueSuccessful -> {
