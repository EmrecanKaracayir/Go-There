...
class GTButtonGray : MaterialButton, AccentStylableView {
    ...
    private val defEnabledFillColor =
        MaterialColors.getColor(this, R.attr.GT_compLayerPrimary, Color.RED)
    private val defDisabledFillColor =
        MaterialColors.getColor(this, R.attr.GT_compLayerSecondary, Color.RED)
